    ...
    <div className='mt-40'>
        ...
        <Image className='w-[250px] mx-auto' src={Stripe}></Image>
            ...
            <select className='outline-none w-[380px] h-[40px] rounded-lg border border-slate-400 pl-5 mb-10'  name="" id="">
                ...
                <option value="In2EdAfrica">In2EdAfrica UAE</option>
            ...
            <button className='flex justify-start items-center gap-4 pl-10 shadow text-lg border text-yellow-600 w-[380px] py-2 mb-2'> <FaBitcoin /> Bitcoin</button>
            <button className='flex justify-start items-center gap-4 pl-10 shadow text-lg border text-slate-600 w-[380px] py-3 mb-2'><FaEthereum /> Ethereum</button>
            <button className='flex justify-start items-center gap-4 pl-10 shadow text-lg border text-green-600 w-[380px] py-3 mb-2'> <TbCoin />USDT</button>
            </div>
            </div>
