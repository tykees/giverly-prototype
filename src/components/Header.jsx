...
export const Header = () => {
  return (
    <div className='container mx-auto'>
        <div className='flex flex-col-reverse justify-around md:flex-row md:px-6 mx-auto pt-10 space-y-0 md:space-y-0 mt-32'>
            <div className='text-center showcase md:w-1/2'>
