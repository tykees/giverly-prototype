  ...
  return (
    <div>
        ...
        <div className='flex flex-col-reverse justify-around md:flex-row md:px-6 mx-auto pt-10 space-y-0 md:space-y-0 '>
            <div className='flex flex-col justify-center items-center w[120px] h-[180px] border rounded-lg shadow-md'>
                <Image className='overimg rounded-full w-[100px]' src={RSPCA} alt='img'/>
                <p className='mt-5 px-2 w-[180px]'>RSPCA South Australia</p>
                <p className='mt-5 px-2 w-[180px]'>54% Discount</p>
                <p className='text-slate-600 ml-40 text-xl flex justify-end items-center'><FaEdit /></p> 
            </div>
            <div className='flex flex-col justify-center items-center w[120px] h-[180px] border rounded-lg shadow-md'>
