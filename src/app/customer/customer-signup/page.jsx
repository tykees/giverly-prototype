  ...
  return (
    <div className='container mx-auto my-18'>
        <div className='flex flex-col justify-around md:flex-row md:px-6 mx-auto pt-10 space-y-0 md:space-y-0 mt-40'>
            ...
            <div className='flex flex-col gap-5 mx-5 md:w-1/2'>
            <p className='text-3xl font-bold'>Customer Sign Up</p>
            {/* <label htmlFor="">Name</label> */}
            <input className='outline-none w-full md:w-[500px] h-[40px] rounded-full border border-slate-900 pl-5 ' placeholder='Full Name' type="text" required name="" id="" />
            {/* <label htmlFor="">Preffered Name</label> */}
            <input className='outline-none w-full md:w-[500px] h-[40px] rounded-full border border-slate-900 pl-5 ' placeholder='Preffered Name' type="text" required name="" id="" />
            <label className='text-sm' htmlFor="">Age Category</label>
            <select className='outline-none w-full md:w-[500px] h-[40px] rounded-full border border-slate-900 pl-5 ' name="" id="">
            ...
            <input className='outline-none w-full md:w-[500px] h-[40px] rounded-full border border-slate-900 pl-5 ' placeholder='Email'  type="email" required name="" id="" />
            <input className='outline-none w-full md:w-[500px] h-[40px] rounded-full border border-slate-900 pl-5 ' placeholder='DOB'  type="data" required name="" id="" />
            {/* <label htmlFor="">Phone No</label> */}
            <input className='outline-none w-full md:w-[500px] h-[40px] rounded-full border border-slate-900 pl-5  ' placeholder='Phone No' type="phone" required name="" id="" />
